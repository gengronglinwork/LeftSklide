...
@interface RLLeftSlideViewController ()<UIGestureRecognizerDelegate,UITabBarControllerDelegate>
{
...
@implementation RLLeftSlideViewController
                     ...
                     andMainView:(UITabBarController *)mainVC
{
    if(self = [super init]){
        ...
        [RLLeftSlideManager sharedIncetance].LeftSlideVC = self;
        [RLLeftSlideManager sharedIncetance].mainNavigationController = mainVC.viewControllers.firstObject;
...
{
    if ([RLLeftSlideManager sharedIncetance].LeftSlideVC.closed)
    {
        [[RLLeftSlideManager sharedIncetance].LeftSlideVC openLeftView];
    }
    else
    {
        [[RLLeftSlideManager sharedIncetance].LeftSlideVC closeLeftView];
    }
}
...
- (void)tabBarController:(UITabBarController *)tabBarController didSelectViewController:(UIViewController *)viewController{
    [RLLeftSlideManager sharedIncetance].mainNavigationController = (UINavigationController *)viewController;
}
